...
import cn.zju.creaturun.ui.activity.MainActivity;
import cn.zju.creaturun.ui.view.LoadingFeedItemView;
...
public class FeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void updateItems(boolean animated, List<String> pictures) {
        feedItems.clear();
        //主界面展示路线点赞数
    ...
    public static class CellFeedViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(FeedItem feedItem) {
            ...
            //主界面路线图片540*540
            //BitmapFfeedItem.picture
            Bitmap bit= BitmapFactory.decodeFile(feedItem.picture);
            ivFeedCenter.setImageBitmap(bit);
            // ivFeedCenter.setImageResource(adapterPosition % 2 == 0 ? R.drawable.img_route1 : R.drawable.img_route2);
    ...
    public static class FeedItem {
        ...
        public FeedItem(int likesCount, boolean isLiked, String picture) {
